...
public class AdminTool3 extends AbstractVerticle {
	final Logger logger = LoggerFactory.getLogger(AdminTool3.class);
	...
	public static void main(String[] args) {
		...
		Runner.runExample(AdminTool3.class);
	...
	public void start(Future<Void> future) throws Exception {
			...
			list.add("maven:io.vertx:service-provider:3.5.3::service-ProcessorService");
			list.add("maven:io.vertx:service-provider2:3.5.3::service-ProcessorService");
